...
def integrate(
    ...
    **integrator_kwargs: dict,
    ...
    if pbar and autobatcher:
        ...
        tqdm_pbar = tqdm(total=state.n_graphs, **pbar_kwargs)
    ...
    for state, batch_indices in batch_iterator:
        ...
        if tqdm_pbar:
            tqdm_pbar.update(state.n_graphs)
...
def generate_force_convergence_fn(
    ...
    def convergence_fn(
        ...
        Returns:
            torch.Tensor: Boolean tensor of shape (n_graphs,) indicating
    ...
    **optimizer_kwargs: dict,
    ...
    Args:
        ...
        convergence_fn (Callable | None): Condition for convergence, should return a
            boolean tensor of length n_graphs
...
def static(
    ...
    *,
    ...
    for sub_state, batch_indices in batch_iterator:
        ...
        if tqdm_pbar:
            tqdm_pbar.update(sub_state.n_graphs)
