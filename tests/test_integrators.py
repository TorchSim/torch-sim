...
def test_npt_langevin(ar_double_sim_state: ts.SimState, lj_model: LennardJonesModel):
    ...
    for _step in range(n_steps):
        ...
        temp = calc_kT(state.momenta, state.masses, graph_idx=state.graph_idx)
...
def test_compute_cell_force_atoms_per_graph():
    """Test that compute_cell_force correctly scales by number of atoms per graph.
